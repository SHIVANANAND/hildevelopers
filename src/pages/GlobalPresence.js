...
const GlobalPresence = () => {
  ...
  return (
    <div>
                ...
                {offices.map((office) => (
                  <motion.button
                    ...
                    className={`w-full text-left p-6 rounded-xl transition-all duration-200 ${
                      selectedOffice === office.id
                        ? `${office.bgColor} border-2 border-current shadow-lg`
                  ...
                  >
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-poppins font-bold text-navy-800 text-lg">
                          {office.country}
                        </h3>
                        <p className="text-silver-600 text-sm">{office.city}</p>
                      </div>
                    </div>
              ...
              {currentOffice && (
                ...
                >
                  <div className="flex items-center mb-6">
                    <div className={`w-16 h-16 bg-gradient-to-r ${currentOffice.color} rounded-xl flex items-center justify-center mr-4`}>
                    ...
                    <div>
                      ...
                      <p className="text-silver-600">{currentOffice.city}</p>
                    </div>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                      <h4 className="font-poppins font-semibold text-navy-800 mb-3">Contact Information</h4>
                    ...
                    <div>
                      <h4 className="font-poppins font-semibold text-navy-800 mb-3">Office Details</h4>
                      <div className="space-y-3 text-sm">
                        <div className="flex items-center">
                          <UsersIcon className="h-5 w-5 text-silver-500 mr-3" />
                          <span className="text-silver-600">{currentOffice.headcount}</span>
                        </div>
                        <div className="flex items-center">
                          <ClockIcon className="h-5 w-5 text-silver-500 mr-3" />
                          <span className="text-silver-600">Established {currentOffice.established}</span>
                        </div>
                        <div className="flex items-start">
                          <CheckCircleIcon className="h-5 w-5 text-silver-500 mr-3 mt-0.5" />
                          <div>
                            <div className="text-silver-600">Certifications:</div>
                            {currentOffice.certifications.map((cert, index) => (
                              <span key={index} className="inline-block bg-silver-100 text-silver-700 text-xs px-2 py-1 rounded mr-1 mt-1">
                                {cert}
                              </span>
                            ))}
                          </div>
                  ...
                  <div>
                    <h4 className="font-poppins font-semibold text-navy-800 mb-4">Specialties & Expertise</h4>
                    <div className="grid grid-cols-1 gap-3">
                      {currentOffice.specialties.map((specialty, index) => (
                        <div key={index} className="flex items-center text-silver-600">
      ...
      <section ref={formRef} className="section-padding bg-silver-50">
        <div className="container-custom">
          <motion.div
            initial="hidden"
          ...
          >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <label htmlFor="office" className="block text-sm font-medium text-navy-800 mb-2">
                    Preferred Office *
                  </label>
                  <select
                    id="office"
                ...
                <div className="md:col-span-2">
                  <label htmlFor="projectType" className="block text-sm font-medium text-navy-800 mb-2">
                    Project Type
                  </label>
                  <select
                    id="projectType"
